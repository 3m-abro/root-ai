...
4. **Gather Evidence in Multi-Component Systems**
   ...
   **BEFORE proposing fixes, add diagnostic instrumentation:**
   ...
   Record only redacted presence/absence and non-sensitive boundary state. Never dump environment values, credentials, keychain contents, or private payloads.
