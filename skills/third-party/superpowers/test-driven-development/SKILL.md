...
Preserve existing work. If implementation preceded the test, establish a reversible regression demonstration within the authorized task; do not delete user or unrelated code.
...
| "Keep as reference, write tests first" | Establish a failing regression safely; preserve existing work. |
...
**Re-establish a failing regression test safely; preserve existing work.**
