...
> **For agentic workers:** Use the ROOT-approved executing-plans copy within the assigned task boundary. Steps use checkbox (`- [ ]`) syntax for tracking.
...
Return the plan to Engineering Head. Use the curated executing-plans copy when implementation is authorized. Subagent-driven-development is deferred; do not install it.
